        ...
        <div className="w-full bg-purple-50 md:py-36 py-10">
            <div className="2xl:container flex justify-between items-center sm:flex-row flex-col mx-auto px-3 h-full gap-11">
                <div className="sm:w-2/3 w-full overflow-hidden py-5 flex justify-center flex-col gap-10 relative">
                    <img src={shape} className="absolute animate-[spin_70s_linear_infinite]"/>
                    <h1 className="lg:text-5xl sm:text-4xl  text-3xl font-bold text-gray-700 z-10">Transfer Your Money At Secure and fastestTransfer Your Remittance At Secure and fastest</h1>
                    <p className="text-sm md:text-base lg:text-lg text-gray-700 font-medium z-10">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Expedita vero eius exercitationem nesciunt iusto quasi facere impedit quas vel? Impedit vel laudantium necessitatibus fugiat.</p>
