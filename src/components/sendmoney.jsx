    ...
    return (
        <form className="flex xl:col-span-4 lg:col-span-3 flex-col gap-8 bg-purple-50 p-8 rounded-lg">
                ...
                <div className="flex w-full flex-col gap-2">
                        <label htmlFor="send">Sending Country</label>
                ...
                <div className="flex w-full flex-col gap-2">
                        <label htmlFor="receive">Receiving Country</label>
                ...
                <div className="flex w-full flex-col gap-2">
                        <label htmlFor="sender">Sender's Currency</label>
                ...
                <div className="flex w-full flex-col gap-2">
                        <label htmlFor="recipient">Recipient's Currency</label>
                ...
                <div className="flex w-full flex-col gap-2">
                    <label htmlFor="recipientInformation">Recipient Information</label>
