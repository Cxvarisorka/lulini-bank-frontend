                    ...
                    <div className="w-full grid xl:grid-cols-3 sm:grid-cols-2 grid-cols-1 lg:gap-10 gap-5 justify-between">
                        {
                            infoContact.map(obj => {
                                return (
                                    <PartContact key={obj.title} title={obj.title} icon={obj.icon} text1={obj.text1} text2={obj.text2}/>
                                )
                            })
                        }
                    </div>
                                ...
                                <div className="grid grid-cols-6 w-full md:gap-7 gap-4">
                                    {
                                        inputs.map(obj => {
                                            return (
                                                <input key={obj.name} className="p-4 border-2 border-purple-500 focus:outline-none rounded col-span-3" {...obj} required />
                                            )
                                        })
                                    }
